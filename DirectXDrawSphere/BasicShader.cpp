...
VertexShader BasicShader::vertexShader = VertexShader(L".//shader//BasicVS.hlsl", "main", "vs_5_0");
PixelShader BasicShader::pixelShader = PixelShader(L".//shader//BasicPS.hlsl", "main", "ps_5_0");
